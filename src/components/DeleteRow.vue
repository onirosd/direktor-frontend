<template>
  <Modal :header="'Eliminar Fila'" :modalType="'deleteRow'" :paragraphs="paragraphs">
    <template>
      <span class="text-sm leading-6 mb-2 w-full">¿Cúantas filas deseas eliminar?</span>
      <input
        type="text"
